...
import { VbenBackTop, VbenLogo, VbenMenuTopLogo } from '@vben-core/shadcn-ui';
...
import ChcSso from './sso/index.vue';
...
<template>
  <ChcSso v-if="ssoStore.isInPortal">
    <template #sso-header>
    ...
    <LayoutContent />
    <template v-if="preferences.transition.loading" #overlay>
  ...
  >
    ...
    <!--  token过期重新登录弹窗 项目更新弹窗 包含锁屏弹窗 偏好设置按钮位置配置为fixed时的按钮 回到顶部按钮 -->
    <template #extra>
