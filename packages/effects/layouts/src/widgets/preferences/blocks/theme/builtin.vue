...
watch(
  ...
  ([themeType, isDark]) => {
    ...
    if (theme) {
      ...
      (theme.headerColor || theme.color) &&
        (themeHeaderColor.value = theme.headerColor || theme.color);
      (theme.sidebarColor || theme.color) &&
        (themeSidebarColor.value = theme.sidebarColor || theme.color);
    }
  },
);
</script>
