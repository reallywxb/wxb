...
<template>
  ...
  <DropdownMenu v-model:open="openPopover">
    <DropdownMenuTrigger ref="refTrigger" :disabled="props.trigger === 'hover'">
      <div
        class="ml-1 mr-2 cursor-pointer rounded px-1.5 py-1 hover:bg-[hsl(var(--header-accent-hover))]"
      >
        <div class="flex-center">
          <VbenAvatar
            :alt="text"
            :src="avatar"
            class="dark:text-foreground dark:bg-secondary size-8 bg-transparent text-[hsl(var(--header-foreground))]"
            dot
          />
        </div>
      </div>
      ...
      <div ref="refContent">
        <DropdownMenuLabel class="flex items-center p-3">
          <!-- <VbenAvatar
            :alt="text"
            :src="avatar"
            class="size-12 !overflow-visible !rounded-none bg-transparent"
            dot
