...
defineSlots<{
  'content'(props: {}): any;
  'content-overlay'(props: {}): any;
  'extra'(props: {}): any;
  'footer'(props: {}): any;
  'header'(props: {}): any;
  'menu'(props: {}): any;
  'mixed-menu'(props: {}): any;
  'side-extra'(props: {}): any;
  'side-extra-title'(props: {}): any;
  'tabbar'(props: {}): any;
  logo(props: { place?: 'header' | 'sidebar' }): any;
  // 'extra'(props: {}): any;
}>();
  ...
  <div class="relative flex min-h-full w-full">
    ...
    >
      <template v-if="isSideMode && !isMixedNav" #logo>
        <slot name="logo" place="sidebar"></slot>
      </template>
      ...
      >
        ...
        >
          <template v-if="showHeaderLogo" #logo>
            <slot name="logo" place="header"></slot>
          </template>

          <template #toggle-button>
            <VbenIconButton
              v-if="showHeaderToggleButton"
              class="dark:hover:bg-accent dark:hover:text-accent-foreground dark:text-foreground/80 my-0 mr-1 rounded-md text-[hsl(var(--header-foreground))] hover:bg-[hsl(var(--header-accent-hover))] hover:text-[hsl(var(--header-accent-foreground))]"
