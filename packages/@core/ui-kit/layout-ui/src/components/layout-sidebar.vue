...
<template>
  ...
  <aside
    :class="[
      theme,
      {
        'dark:bg-sidebar-deep bg-sidebar': isSidebarMixed,
        'dark:bg-sidebar dark:border-border bg-sidebar border-r border-[hsl(var(--sidebar-accent-active))] dark:border-r':
          !isSidebarMixed,
      },
    ]"
    :style="style"
  ...
  >
    ...
    <div
      ...
      :style="extraStyle"
      class="dark:border-border bg-sidebar fixed top-0 h-full overflow-hidden border-r border-[hsl(var(--sidebar-accent-active))] transition-all duration-200"
    >
      <SidebarCollapseButton
