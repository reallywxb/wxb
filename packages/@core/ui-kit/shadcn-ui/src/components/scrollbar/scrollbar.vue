...
<template>
  ...
  >
    <div
      ...
      :class="{
        'opacity-100': !isAtTop,
        'dark:border-border border-t border-[hsl(var(--sidebar-accent-active))] dark:border-t':
          shadowBorder && !isAtTop,
      }"
    ...
    <div
      ...
      :class="{
        ...
        'dark:border-border border-b border-[hsl(var(--sidebar-accent-active))] dark:border-b':
