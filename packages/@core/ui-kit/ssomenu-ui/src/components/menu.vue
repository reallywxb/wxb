...
<template>
  <ul
    ...
    :class="[
      ...
      place === 'header' ? 'isInHeader' : 'isInSidebar',
    ]"
    :style="menuStyle"
    role="menu"
  >
    <template v-if="mode === 'horizontal' && getSlot.showSlotMore">
      ...
      <SubMenu is-sub-menu-more path="sub-menu-more" :place="place">
        <template #title>
...
.#{$namespace}-menu {
  ...
  &.isInHeader.is-light {
    --menu-background-color: hsl(var(--header));
    // --menu-submenu-opened-background-color: hsl(var(--menu-opened));
    --menu-item-background-color: hsl(var(--header));
    --menu-item-color: hsl(var(--header-foreground));
    --menu-item-hover-color: hsl(var(--header-accent-foreground));
    --menu-item-hover-background-color: hsl(var(--header-accent-hover));
    --menu-item-active-color: hsl(var(--header-accent-foreground));
    --menu-item-active-background-color: hsl(var(--header-accent-active));
    --menu-submenu-background-color: hsl(var(--header));
    --menu-submenu-hover-color: hsl(var(--header-accent-foreground));
    --menu-submenu-hover-background-color: hsl(var(--header-accent-hover));
    --menu-submenu-active-color: hsl(var(--header-accent-foreground));
    --menu-submenu-active-background-color: transparent;
  }

  &.isInSidebar.is-light {
    --menu-background-color: hsl(var(--sidebar));
    // --menu-submenu-opened-background-color: hsl(var(--menu-opened));
    --menu-item-background-color: hsl(var(--sidebar));
    --menu-item-color: hsl(var(--sidebar-foreground));
    --menu-item-hover-color: hsl(var(--sidebar-accent-foreground));
    --menu-item-hover-background-color: hsl(var(--sidebar-accent-hover));
    --menu-item-active-color: hsl(var(--sidebar-accent-foreground));
    --menu-item-active-background-color: hsl(var(--sidebar-accent-active));
    --menu-submenu-background-color: hsl(var(--sidebar));
    --menu-submenu-hover-color: hsl(var(--sidebar-accent-foreground));
    --menu-submenu-hover-background-color: hsl(var(--sidebar-accent-hover));
    --menu-submenu-active-color: hsl(var(--sidebar-accent-foreground));
    --menu-submenu-active-background-color: transparent;
  }
  ...
  &.is-horizontal {
    ...
    &.isInHeader.is-light {
      ...
      --menu-submenu-hover-background-color: hsl(var(--header-accent-hover));
      --menu-submenu-active-color: hsl(var(--header-accent-foreground));
      --menu-submenu-active-background-color: hsl(var(--header-accent-active));
    }
    ...
    &.isInSidebar.is-light {
      ...
      --menu-submenu-hover-background-color: hsl(var(--sidebar-accent-hover));
      --menu-submenu-active-color: hsl(var(--sidebar-accent-foreground));
      --menu-submenu-active-background-color: hsl(var(--sidebar-accent-active));
    }
  }
}
