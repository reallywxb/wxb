...
const { modificationModalRef, formOption, handleEdit, handleDel, handleFile } =
  ...
  <Page content-class="p-[0.5rem]" auto-content-height header-class="px-3 py-2">
    <Grid>
      ...
      <template #action="{ row }">
        ...
        <Tooltip effect="dark" title="查看文件" placement="top">
          <Button type="link" danger @click="handleFile(row)">
            <template #icon>
