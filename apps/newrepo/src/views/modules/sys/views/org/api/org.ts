...
export async function createOrg(data: any) {
  return requestClient.post('/sys/org/datatable/create/sys.org', data);
}

export async function updateOrg(data: any) {
  return requestClient.post('/sys/org/datatable/update/sys.org', data);
}

export async function delOrg(id: number | string) {
  return requestClient.post('/sys/org/datatable/delete/sys.org', { id });
}
...
export function getSettingGroupList() {
