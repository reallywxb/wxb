      ...
      <ChcGrid>
        <template #descriptionDefault="scope">
          <Input
            ...
            :data-testid="`input_description_${scope.rowIndex}_editMoadl`"
          />
        </template>
        <template #qtyOrderedDefault="scope">
          <InputNumber
            ...
            :data-testid="`input_qtyOrdered_${scope.rowIndex}_editMoadl`"
          />
        </template>
        <template #toolbar-actions>
          <Button
            ...
            danger
            @click="handleDel"
            data-testid="button_del_editMoadl"
          >
            删除
            <template #icon>
              <SvgDeleteIcon />
        ...
        <template #toolbar-tools>
          <Input
            ...
            data-testid="input_productName_editMoadl"
          />
          <Button
            type="primary"
            @click="handleSearch"
            data-testid="button_search_editMoadl"
          >
            搜索
            <template #icon>
              <SearchActionIcon />
          ...
          <div class="flex items-center justify-center pt-[10px]">
            <div class="flex gap-[10px]">
              <Button
                type="primary"
                @click="handleSave"
                data-testid="button_save_editMoadl"
              >
                保存
                <template #icon>
                  <SvgSaveIcon />
              ...
              <Button
                ...
                data-testid="button_cancel_editMoadl"
              >
                取消
                <template #icon>
                  <SvgCloseIcon />
