      ...
      },
      {
        ...
        componentProps: () => {
          return {
            ...
            labelField: 'name',
            valueField: 'id',
            'data-testId': 'ChcSelect_departmentId',
            allowClear: true,
            afterFetch(res: any) {
...
const handleSubmit = (row: any) => {
  Modal.confirm({
    ...
    onOk() {
      ...
      requestFormClient
        .post('orderAction/commitSurgery.do?page=surgeryComplete', {
        ...
        <ChcGrid>
          ...
          <template #action="scope">
            ...
            <Button
              ...
              :data-testid="`button_edit_${scope.rowIndex}_mainPage`"
            >
              修改
              <template #icon>
                <EditActionIcon />
            ...
            <Button
              ...
              class="mr-[6px] h-[24px] pb-0 pl-[6px] pr-[6px] pt-0"
              :data-testid="`button_del_${scope.rowIndex}_mainPage`"
            >
              删除
              <template #icon>
                <SvgDeleteIcon />
            ...
            <Button
              ...
              :data-testid="`button_confirm_${scope.rowIndex}_mainPage`"
            >
              消耗确认
              <template #icon>
                <SvgSquareTickIcon />
        ...
        <ChildGrid class="childGrid">
          <template #qtyProcessDefault="scope">
            <InputNumber
              ...
              :data-testid="`input_qtyProcess_${scope.rowIndex}_mainPage`"
            />
          </template>
          <template #toolbar-actions>
            <Input
              ...
              allow-clear
              data-testid="input_search_productName_mainPage"
            />
            <Button
              type="primary"
              @click="handleSearch"
              class="mr-[0.5rem]"
              data-testid="button_childSearch_mainPage"
            >
              搜索
              <template #icon>
                <SearchActionIcon />
