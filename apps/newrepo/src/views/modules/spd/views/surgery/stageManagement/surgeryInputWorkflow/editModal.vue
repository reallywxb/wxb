      ...
      <ChcGrid>
        ...
        <template #toolbar-actions>
          <Button
            ...
            danger
            @click="handleDel"
            data-testid="button_handleDel_editModal"
          >
            删除
            <template #icon>
              <SvgDeleteIcon />
        ...
        <template #toolbar-tools>
          <Input
            ...
            data-testid="input_productNameSearch_editModal"
          />
          <Button
            type="primary"
            @click="handleSearch"
            data-testid="button_handleSearch_editModal"
          >
            搜索
            <template #icon>
              <SearchActionIcon />
          ...
          <div class="flex items-center justify-center pt-[10px]">
            <div class="flex gap-[10px]">
              <Button
                type="primary"
                @click="handleSave"
                data-testid="button_handleSave_editModal"
              >
                保存
                <template #icon>
                  <SvgSaveIcon />
              ...
              <Button
                ...
                data-testid="button_handleCancel_editModal"
              >
                取消
                <template #icon>
                  <SvgCloseIcon />
