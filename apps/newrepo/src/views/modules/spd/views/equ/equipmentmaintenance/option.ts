...
export const formOptions: any = {
  schema: [
    ...
    {
      label: '养护记录ID',
      fieldName: 'EQU_EquipmentMaintenance_ID',
      component: 'Input',
      rules: 'required',
      hidden: true,
    },
    ...
    {
      label: '养护方式',
      fieldName: 'MaintenanceMethod',
      component: 'Input',
    },
    {
      label: '养护结果',
      fieldName: 'MaintenanceResult',
      component: 'Input',
      formItemClass: 'col-span-2',
    },
    {
      label: '养护建议',
      fieldName: 'MaintenanceAdvice',
      component: 'Input',
      formItemClass: 'col-span-2',
    },
  ],
...
const useGridOptions: (
  ...
  return {
    gridColumns: [
      ...
      {
        title: '养护记录ID',
        field: 'EQU_EquipmentMaintenance_ID',
        sortable: true,
        key: true,
        minWidth: 30,
        width: 140,
    ...
    permissions: {
      add: 'spd.web.equ.equipmentmaintenance.add',
      edit: 'spd.web.equ.equipmentmaintenance.edit',
      delete: 'spd.web.equ.equipmentmaintenance.delete',
      view: 'spd.web.equ.equipmentmaintenance',
      export: 'spd.web.equ.equipmentmaintenance.export',
    },
    id: 'equ.equipmentmaintenance',
    dataTableId: 'equ.equipmentmaintenance',
    showToolbar: true,
