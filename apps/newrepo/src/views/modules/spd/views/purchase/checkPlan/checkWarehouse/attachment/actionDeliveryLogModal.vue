...
const getFileUrl = () => {
  ...
  return `${getBaseUrl()}${import.meta.env.VITE_GLOB_API_URL}/attachAction/viewScpAttach.do?type=asn&siteAttachId=${currentRow.value.siteAttachId}`;
};
...
const [ChcGrid, ChcGridApi] = useSpdGrid(
  ...
  },
  {
    ...
    dataTableId: '/asnAction/queryAsnAttach.do',
...
const handleQuery = (data: any) => {
  searchForm.value.asnId = data.asnId;
  ChcGridApi.query();
};
    ...
    <ChcGrid>
      <template #action="scope">
        <Button
          ...
          "
          data-testid="button_view_actionDeliveryLogModal"
        >
          查看
        </Button>
      </template>
