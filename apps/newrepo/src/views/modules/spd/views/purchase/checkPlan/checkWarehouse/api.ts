...
export const queryOrderPlanLineInfo = (params: any) => {
  return requestFormClient.post<OrderPlanLineInfo>(
    ...
    '/asnAction/queryLine.do?specShowType=from',
    params,
  );
};
...
export const saveLine = (params: any) => {
  return requestFormClient.post<any>('/asnAction/saveUpdatedLine.do', params);
  // return requestFormClient.post<any>('/orderPlanAction/saveLine.do', params);
};
export const saveDo = (params: any) => {
  // return requestFormClient.post<any>('/asnAction/saveUpdatedLine.do', params);
  return requestFormClient.post<any>('/asnAction/save.do', params);
};
export const invalidateCancel = (params: any) => {
  return requestFormClient.post<any>('/asnAction/delete.do', params);
};
export const dataCommit = (params: any) => {
  return requestFormClient.post<any>('/asnAction/commit.do', params);
};
...
export const changeLot = (params: any) => {
  return requestFormClient.post<any>('/asnAction/changeLot.do', params);
};
...
export const verifyCheck = (params: any) => {
  return requestFormClient.post<any>('/asnAction/verifyCheck', params);
};
