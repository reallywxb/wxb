...
// 扫码验收列表
export const queryCode = (params: any) => {
  return requestFormClient.post<any>('/packageAction/query.do', params);
};
// 开箱验视
export const openPackage = (params: any) => {
  return requestFormClient.post<any>('/asnAction/inspectePackage.do', params);
};
// 验收包装
export const checkPackage = (params: any) => {
  return requestFormClient.post<any>('/asnAction/checkPackage.do', params);
};
