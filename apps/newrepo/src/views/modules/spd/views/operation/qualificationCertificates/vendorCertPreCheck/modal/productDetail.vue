          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_productCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_vendorCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_manufCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_toggle_authorize_${index}_productDetail`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_view_license_authorize_${index}_productDetail`"
                  >
                    证照查看
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_view_license_authorizeLines_${index}_productDetail`"
                      >
                        证照查看
                      </Button>
                    </div>
