...
const [ModalFirst, modalApi] = useVbenModal({
  ...
  async onOpenChange(isOpen: boolean) {
    if (isOpen) {
      ...
      const result: any = await requestFormClient.post(
...
const prepareLicenseViewData = (cert: any, btnType: string, index?: number) => {
  ...
  return {
    applySyncId: state.value.applyId, // 外层applyId
    applyCertId: certId,
    type,
    isWA: state.value.checkStatus === 'WA', // 是否预审状态
  ...
  Modal.confirm({
    ...
    async onOk() {
      try {
        ...
        // 调用接口
        const result = await requestFormClient.post(
...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_reject_reason_productDetail',
    }),
    width: '400px',
    centered: true,
    async onOk() {
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_productCert_${index}_productDetail_`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_vendorCert_${index}_productDetail_`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_manufCert_${index}_productDetail_`"
              >
                证照查看
              </Button>
            </div>
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_check_detail_authorize_${index}_productDetail_`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_view_license_authorize_${index}_productDetail_`"
                  >
                    证照查看
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_view_license_authorizeLines_${lineIndex}_productDetail_`"
                      >
                        证照查看
                      </Button>
                    </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_contract_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
        ...
        <div class="tutorial-field">
          ...
          <div class="tutorial-field-content">
            <Button
              ...
              class="mx-2"
              @click="handleAdd"
              data-testid="button_add_productDetail"
            >
              新增
            </Button>
            <ChcGrid>
              <template #action="scope">
                <Button
                  ...
                  :data-testid="`button_delete_${scope.rowIndex}_productDetail`"
                >
                  删除
                </Button>
              </template>
      ...
      >
        <div class="flex gap-[10px]">
          <Button
            type="primary"
            @click="handlePass"
            data-testid="button_pass_productDetail"
          >
            通过
            <template #icon>
              <SvgSaveIcon />
          ...
          <Button
            ...
            danger
            @click="handleReject"
            data-testid="button_reject_productDetail"
          >
            拒绝
            <template #icon>
              <SvgCloseIcon />
          ...
          <Button
            ...
            data-testid="button_cancel_productDetail"
          >
            取消
            <template #icon>
              <SvgCloseIcon />
