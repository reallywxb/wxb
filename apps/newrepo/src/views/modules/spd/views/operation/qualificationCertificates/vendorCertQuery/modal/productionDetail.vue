...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_rejectReason_productionDetail',
    }),
    width: '400px',
    centered: true,
    async onOk() {
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_vendorCert_${index}_productionDetail`"
              >
                证照核对
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_manufCert_${index}_productionDetail`"
              >
                证照核对
              </Button>
            </div>
