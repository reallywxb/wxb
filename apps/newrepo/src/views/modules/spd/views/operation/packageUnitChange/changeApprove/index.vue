...
const [ChcGrid, ChcGridApi] = useSpdGrid(
  ...
  },
  {
    id: 'changeApprove',
    // api地址
    queryUrl: '/packUnitChangeApplyAction/query.do?page=audit',
    gridColumns: [
      {
        type: 'radio',
        title: '单选',
...
const handleApprove = async () => {
  ...
  Modal.confirm({
    ...
    onOk: async () => {
      try {
        await requestFormClient.post(`/packUnitChangeApplyAction/check.do`, {
          applyId: JSON.stringify([unProxyRow.packUnitChangeApplyID]),
        });
