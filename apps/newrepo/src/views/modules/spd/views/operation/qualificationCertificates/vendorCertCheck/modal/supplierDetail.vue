...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_reject_reason_supplierDetail',
    }),
    width: '400px',
    centered: true,
    async onOk() {
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_vendorCert_${index}_supplierDetail`"
              >
                证照核对
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_manufCert_${index}_supplierDetail`"
              >
                证照核对
              </Button>
            </div>
      ...
      >
        <div class="flex gap-[10px]">
          <Button
            type="primary"
            @click="handlePass"
            data-testid="button_pass_supplierDetail"
          >
            通过
            <template #icon>
              <SvgSaveIcon />
          ...
          <Button
            ...
            danger
            @click="handleReject"
            data-testid="button_reject_supplierDetail"
          >
            拒绝
            <template #icon>
              <SvgCloseIcon />
          ...
          <Button
            ...
            data-testid="button_cancel_supplierDetail"
          >
            取消
            <template #icon>
              <SvgCloseIcon />
