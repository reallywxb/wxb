...
import type { FilePathsItem } from './api';
        ...
        <div class="flex h-full flex-col gap-2 px-2.5 py-3">
          ...
          >
            ...
            <div
              ...
              :data-testid="`button_viewPicture_${imageIndex}_previewImageModel`"
            >
              <div
          ...
          <div class="flex min-h-0 flex-1 items-center justify-center">
            ...
            <iframe v-show="showPdf" :src="currentImageUrl" class="preview-pdf" frameborder="0" />
