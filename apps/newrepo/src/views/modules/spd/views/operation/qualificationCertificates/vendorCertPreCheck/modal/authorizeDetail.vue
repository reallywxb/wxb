              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_toggle_authorize_${certIndex}_authorizeDetail`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_view_license_authorize_${certIndex}_authorizeDetail`"
                  >
                    证照核对
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_view_license_authorizeLines_${lineIndex}_authorizeDetail`"
                      >
                        证照核对
                      </Button>
                    </div>
