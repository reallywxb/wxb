...
import type { LicenseDetailResponse, VendorRowType } from '../type';
...
const [ModalFirst, modalApi] = useVbenModal({
  ...
  onOpenChange: async (isOpen: boolean) => {
    if (isOpen) {
      ...
      const result: LicenseDetailResponse = await requestFormClient.post(
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_vendorCert_${index}_detail`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_manufCert_${index}_detail`"
              >
                证照查看
              </Button>
            </div>
