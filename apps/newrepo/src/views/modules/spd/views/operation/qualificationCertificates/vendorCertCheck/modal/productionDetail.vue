...
import type { VendorRowType } from '#/views/modules/spd/views/operation/qualificationCertificates/companyCertPreCheck/api';
...
import {
  applyOrReject,
  getSyncApplyDetail,
} from '#/views/modules/spd/views/operation/qualificationCertificates/companyCertPreCheck/api';
import pictureView from '#/views/modules/spd/views/operation/qualificationCertificates/companyCertPreCheck/modal/pictureView.vue';
...
const state = ref<any>();
const manufCerts = ref<VendorRowType[]>([]); // 生产企业证照
const vendorCerts = ref<VendorRowType[]>([]); // 供应商证照
...
const handlePass = () => {
  ...
  [...(vendorCerts.value || []), ...(manufCerts.value || [])].forEach(
    (cert: VendorRowType) => {
      const certName = cert.certTypeName || '未知证照';
...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_reject_reason_productionDetail',
    }),
    width: '400px',
    centered: true,
    async onOk() {
...
const handlehandleViewLicense = (cert: VendorRowType, type: string) => {
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_vendorCert_${index}_productionDetail_`"
              >
                证照核对
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_view_license_manufCert_${index}_productionDetail_`"
              >
                证照核对
              </Button>
            </div>
      ...
      >
        <div class="flex gap-[10px]">
          <Button
            type="primary"
            @click="handlePass"
            data-testid="button_pass_productionDetail"
          >
            通过
            <template #icon>
              <SvgSaveIcon />
          ...
          <Button
            ...
            danger
            @click="handleReject"
            data-testid="button_reject_productionDetail"
          >
            拒绝
            <template #icon>
              <SvgCloseIcon />
          ...
          <Button
            ...
            data-testid="button_cancel_productionDetail"
          >
            取消
            <template #icon>
              <SvgCloseIcon />
