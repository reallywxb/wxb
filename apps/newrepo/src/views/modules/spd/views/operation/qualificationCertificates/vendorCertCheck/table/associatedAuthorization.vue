...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_reject_reason_associatedAuthorization',
    }),
    onOk: async () => {
      const rejectReason = (
    ...
    <ChcGrid>
      <template #toolbar-actions>
        ...
        <Button
          ...
          @click="handleSearch"
          class="mr-[0.5rem]"
          data-testid="button_search_associatedAuthorization"
        >
          查询
          <template #icon>
            <SearchActionIcon />
        ...
        <Button
          ...
          class="mr-[0.5rem]"
          data-testid="button_approval_associatedAuthorization"
        >
          通过
          <template #icon>
            <SvgSquareTickIcon />
        ...
        <Button
          ...
          @click="handleReject"
          class="mr-[0.5rem]"
          data-testid="button_reject_associatedAuthorization"
        >
          拒绝
          <template #icon>
            <SvgCloseIcon />
      ...
      <template #action="scope">
        <Button
          ...
          :data-testid="`button_view_license_${scope.index}_associatedAuthorization`"
        >
          证照详情
          <template #icon>
            <IconfontBasicView />
