...
const [ChcGrid, ChcGridApi] = useSpdGrid(
  {
    gridOptions: deepMerge(gridDefaultOptions, {
      ...
      rowClassName: ({ row }: { row: any }) => {
        ...
        return colorMap[row.warningLevel as keyof typeof colorMap] || '';
      },
    }),
    // 添加表格事件监听
    gridEvents: {
  ...
  },
  {
    ...
    id: 'supplierLicense',
    dataTableId: `/companyAction/queryCert.do?isVendor=${tableSearchExtraParams.isVendor}`,
    ...
    <ChcGrid>
        ...
        >
          ...
          >
            <Select
              ...
              data-testid="select_certvalid_supplierLicense"
            />
          </FormItem>
          <FormItem>
            <Button
              ...
              html-type="submit"
              class="mr-[0.5rem]"
              data-testid="button_query_supplierLicense"
            >
              查询
              <template #icon>
                <SearchActionIcon />
      ...
      <template #action="scope">
        <Button
          ...
          data-testid="button_viewDetail_supplierLicense"
        >
          证照详情
          <template #icon>
            <IconfontBasicView />
