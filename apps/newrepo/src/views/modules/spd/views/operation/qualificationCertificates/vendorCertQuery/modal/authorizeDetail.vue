...
const handleReject = () => {
  ...
  Modal.confirm({
    ...
    content: h('textarea', {
      ...
      'data-testid': 'textarea_rejectReason_authorizeDetail',
    }),
    width: '400px',
    centered: true,
    async onOk() {
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  ...
                  <Button
                    ...
                    :data-testid="`button_viewLicense_${index}_authorizeDetail`"
                  >
                    证照核对
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_viewLicense_authorizeLines_${lineIndex}_authorizeDetail`"
                      >
                        证照核对
                      </Button>
                    </div>
