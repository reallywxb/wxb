...
import type { AuthorizeDetail } from '../api';
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_Authorize_${certIndex}_detail`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    data-testid="button_viewLicense_authorize_detail"
                  >
                    证照核对
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        data-testid="button_viewLicense_authorizeLines_detail"
                      >
                        证照核对
                      </Button>
                    </div>
