          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_productCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_vendorCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_manufCert_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_toggleAuthorize_${index}_productDetail`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_viewLicense_authorize_${index}_productDetail`"
                  >
                    证照查看
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_viewLicense_authorizeLines_${lineIndex}_productDetail`"
                      >
                        证照查看
                      </Button>
                    </div>
          ...
          <div class="tutorial-field-content">
            ...
            >
              ...
              <Button
                ...
                :data-testid="`button_viewLicense_contract_${index}_productDetail`"
              >
                证照查看
              </Button>
            </div>
