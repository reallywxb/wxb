...
import type { AuthorizeDetail, AuthorizeDetailResponse } from '../type';
...
const [ModalFirst, modalApi] = useVbenModal({
  ...
  onOpenChange: async (isOpen: boolean) => {
    if (isOpen) {
      ...
      const result: AuthorizeDetailResponse = await requestFormClient.post(
              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_toggle_authorize_${certIndex}_detailView`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_view_license_${certIndex}_detailView`"
                  >
                    证照核对
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_view_license_line_${lineIndex}_detailView`"
                      >
                        证照核对
                      </Button>
                    </div>
