              ...
              <div class="auth-box">
                <div class="cert-item default">
                  <div class="first">
                    <div class="certNum" style="width: 260px">
                      <div
                        ...
                        :data-testid="`button_toggle_authorize_${certIndex}_detail`"
                      >
                        <i
                          class="arrow"
                          :class="{
                  ...
                  <Button
                    ...
                    :data-testid="`button_view_license_${certIndex}_detail`"
                  >
                    证照核对
                  </Button>
                </div>
                  ...
                  <div class="line-content">
                    ...
                    >
                      ...
                      <Button
                        ...
                        :data-testid="`button_view_license_line_${lineIndex}_detail`"
                      >
                        证照核对
                      </Button>
                    </div>
