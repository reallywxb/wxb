...
import { createPrinter, delPrinter, updatePrinter } from './api';
...
export function useGrid() {
  ...
  const [Grid, gridApi] = useCommonGrid(
    ...
    {
      dataTableId: '/datatable/data/page/rp.printer',
    },
  );
...
export function useCommonModal(gridApi: VxeGridApi) {
  ...
  function handleAdd() {
    ...
    modificationModalRef.value?.modalApi
      .setData({
        title: '新增',
        submit: (params: any) => createPrinter(params),
      })
      .open();
  }
