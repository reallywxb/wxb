...
<template>
  ...
  >
    ...
    <Card class="mb-5" title="组件形式控制 - 权限码">
      <AccessControl :codes="['sys.userOrg.edit']" type="code">
        <Button class="mr-4"> Super 账号可见 ["sys.userOrg.edit"] </Button>
      </AccessControl>
    ...
    <Card class="mb-5" title="指令方式 - 权限码">
      <Button class="mr-4" v-access:code="['ec.itemData.add']">
        Super 账号可见 ["ec.itemData.add"]
      </Button>
